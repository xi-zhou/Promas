...
public class TransmissionModel {
	...
	static JepConfig config = new JepConfig().setRedirectOutputStreams(true);
	...
	public synchronized void loadModel() throws JepException {
		//JepConfig config = new JepConfig().setRedirectOutputStreams(true);
		//SharedInterpreter.setConfig(config);
		interp= new SharedInterpreter();

		//interp = new JepConfig().setRedirectOutputStreams(true).createSubInterpreter();
