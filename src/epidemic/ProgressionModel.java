...
public class ProgressionModel {
  ...
  public static void quarantine() throws JepException {
    ...
    interp.eval(
        "resultQua = get_evaluatable().create_from(PrologFile('/Users/z.x/eclipse-workspace-2020-06/Promas/misc/quarantine.pl')).evaluate()");
  ...
  public static void resistant() throws JepException {
    ...
    interp.eval("import json");
    interp.eval(
        "resultVacc = get_evaluatable().create_from(PrologFile('/Users/z.x/eclipse-workspace-2020-06/Promas/misc/resistant.pl')).evaluate()");
  ...
  public static void dies() throws JepException {
    ...
    interp.eval("import json");
    interp.eval(
        "result = get_evaluatable().create_from(PrologFile('/Users/z.x/eclipse-workspace-2020-06/Promas/misc/death.pl')).evaluate()");
  ...
  /**
   * extract agent names and probability from JEP.
   * 
   * @param trans identifier of result of problog model
   * @return a map with names as key and probability as value
   */
